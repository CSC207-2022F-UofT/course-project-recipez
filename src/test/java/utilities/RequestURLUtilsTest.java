...
public class RequestURLUtilsTest {
    ...
    public void createUnfilteredSearchURL() {
        ...
        rq.setIngredients(new String[]{"medium eggplant", "green lentils", "red pepper", "onion", "garlic", "cumin powder", "coriander powder", "curry powder", "rolled oats", "olive oil"});
        ...
        Assertions.assertEquals(
                expected,
                RequestURLUtils.createSearchURL(rq)
        );
    }
}
